...
Migracja `2026_08_13_088000_create_ksef_offline_technical_corrections.php` tworzy prywatny magazyn artefaktów oraz nullable, unikalne powiązanie submissionu. Na bazie operatora pozostaje `Pending`; implementacja nie uruchomiła migracji, live HTTP ani transmisji. Production pozostaje zablokowane, brak auto-send, kolejek, listenerów i zmian harmonogramu. Audyt oparto na oficjalnych baseline'ach CIRFMF/ksef-api `93b843d5def041f69fe2a26d0d90a53e9fa9987a` oraz CIRFMF/ksef-client-csharp `04f01c1c7834336a3aef1804149cd5bcbd883a3e`, w szczególności dokumentach `offline/korekta-techniczna.md`, `tryby-offline.md` i aktualnym changelogu API.
