...
Nowa schema-only migracja `2026_08_13_087000_add_ksef_offline_correction_financial_evidence.php` dodaje nullable `longText` `correction_financial_evidence`, bez backfillu lub modyfikacji istniejącego XML. Pole ma cast `encrypted:array`, jest ukryte w serializacji i podlega blokadom zmian/usunięcia issuance. Jest wymagane przed utworzeniem każdej nowej Korekty Offline24/planned/failure; zwykłe Faktury Offline zachowują `NULL`. Historyczna Korekta bez evidence byłaby blokowana, bez rekonstrukcji ze zmiennych danych. Read-only preflight 05.09.2026 potwierdził jeden OfflineIssuance Faktury i zero historycznych Korekt Offline.

Nie rozszerzono XML, QR ani UPO o evidence; nie jest ono wysyłane do KSeF ani pokazywane w UI lub logach. Nie zmieniono źródeł Korekt, ochrony TOCTOU, delivery, terminów, transportu exact frozen XML ani Korekt Online. Brak live HTTP, zapisów operatorowych, korekty technicznej i 8C.7. Migracje operatora `079000–086000` pozostają Ran, a nowa `087000` pozostaje **PENDING** i nie została uruchomiona.

Status po pełnej regresji: `KSeF.8C.6.1: PASS / CLOSED via 8C.6.2`, `KSeF.8C.6.2: PASS / CLOSED`, `KSeF.8C.6 CODE: PASS / CLOSED`. Wszystkie testy przeszły: Unit KSeF 422 / 1412 asercji, Feature KSeF 927 / 6777, full suite 2240 / 13800. Potwierdzono brak regresji zwykłych Faktur Offline i Korekt Online, dokładny transport, QR, UPO, źródła, TOCTOU, delivery, terminy i read-only UI. Operacyjne zamknięcie bazy nastąpi osobno po audycie i kontrolowanej migracji `087000`, która nadal ma status **PENDING**.
