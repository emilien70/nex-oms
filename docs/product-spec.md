...
Numer lub oznaczenie KSeF jest obowiązkowe; checkbox innych formatów nie może go wyłączyć. Poprawny własny NrKSeF PROD ma pierwszeństwo. Potwierdzone lokalne wystawienie poza KSeF daje BFK, ustawowa awaria daje OFF, offline24/niedostępność bez numeru daje DI. Dane TEST/DEMO nie stanowią dowodu PROD. Brak dowodu wymaga jawnego wyboru dla konkretnego ID, bez masowego domyślnego BFK. Ręczny wybór nie może nadpisać numeru ani konfliktu transmisji. Jest to stan lokalny w chwili eksportu, nie rekonstrukcja wcześniejszego złożenia JPK.
