...
Status końcowy: `KSeF.8C.6.1: PASS / CLOSED`, `KSeF.8C.6.2: PASS / CLOSED`, `KSeF.8C.6 migration 087000: PASS / CLOSED`, `KSeF.8C.6-DB-VERIFY-002: PASS / CLOSED`, `KSeF.8C.6-LIVE-AUTH-PREFLIGHT-003: PASS / CLOSED`, `KSeF.8C.6-LIVE-TEST-001: PASS / CLOSED` oraz `KSeF.8C.6: CODE + MIGRATION + DB VERIFY + LIVE DEMO E2E PASS / CLOSED`. Wynik dotyczy DEMO; Production pozostaje zablokowane przez operational environment policy. `KSeF.8C.7: NEXT / NOT STARTED`; korekta techniczna po rejection nie została wdrożona. Korekta biznesowa 8C.6 zachowuje `offlineMode=true` i brak `hashOfCorrectedInvoice`.
