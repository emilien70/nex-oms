...
class OrderPaymentStateTest extends TestCase
{
    ...
    public function test_recalculation_keeps_a_fully_paid_order_fully_paid_after_total_increase(): void
    {
        $order = $this->paymentOrder([
            'payment_status' => 'paid',
            'paid_amount' => '100.00',
        ...
        $this->assertSame('120.00', $order->paid_amount);
        $this->assertSame('paid', $order->payment_status);
    }
    ...
    public function test_recalculation_rejects_an_overpayment_without_changing_order_totals(): void
    {
        $order = $this->paymentOrder(['paid_amount' => '80.00']);
        $this->paymentItem($order, '60.00');
