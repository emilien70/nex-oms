...
class InPostCourierParcelTemplateController extends Controller
{
    public function store(Request $request, InPostCourierParcelTemplateService $templates): RedirectResponse
    {
        ...
        return redirect()->route('integrations.couriers.inpost-courier.edit');
    }
    ...
    {
        $validated = $request->validateWithBag('parcelTemplate', [
            'template_name' => ['required', 'string', 'max:100'],
            'template_weight' => ['required', 'numeric', 'gt:0', 'max:50'],
            'template_length' => ['required', 'numeric', 'gt:0', 'max:350'],
            'template_width' => ['required', 'numeric', 'gt:0', 'max:350'],
            'template_height' => ['required', 'numeric', 'gt:0', 'max:350'],
