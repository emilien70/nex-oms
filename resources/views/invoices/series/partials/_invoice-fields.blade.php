...
<div class="alert alert-info invoice-series-readiness-note mt-3 mb-0" role="note">
    ...
    <span>Przed wystawieniem faktury wymagane będzie uzupełnienie podstawowych danych sprzedawcy.</span>
</div>
...
<div class="invoice-series-sections">
    ...
    @include('invoices.series.partials.invoice._correction-series')
